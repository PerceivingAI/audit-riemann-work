...
**Document type: initial execution-plan document, not an audit report.** Phase 0 and Phase 1 technical gates have passed; see the [Phase 0 report](reports/interim/PASS_4_PHASE_0_REPORT.md) and [Phase 1 report](reports/interim/PASS_4_PHASE_1_REPORT.md) for evidence and limitations. The exact original plan is preserved as [FOURTH_AUDIT.md](FOURTH_AUDIT.md), the execution-plan authority. This document does not report completed Pass 4 work or authorize a consolidated final audit.
