...
**Document type: initial execution-plan document, not an audit report.** Phase 0, Phase 1, Phase 2, Phase 3, and Phase 4 technical gates have passed; see the [Phase 0 report](reports/interim/PASS_4_PHASE_0_REPORT.md), [Phase 1 report](reports/interim/PASS_4_PHASE_1_REPORT.md), [Phase 2 report](reports/interim/PASS_4_PHASE_2_REPORT.md), [Phase 3 report](reports/interim/PASS_4_PHASE_3_REPORT.md), and [Phase 4 report](reports/interim/PASS_4_PHASE_4_REPORT.md) for evidence and limitations. The exact original plan is preserved as [FOURTH_AUDIT.md](FOURTH_AUDIT.md), the execution-plan authority. This document does not report completed Pass 4 work or authorize a consolidated final audit.
